...
function engine:initNames()
		self.core_name		= "Aircrafts/Engines/UH-60L/FrontEngine" -- path to sdef files in the [Mods\aircraft\PlaneXXX\Sounds\Effects\Aircrafts\Engines\PlaneXXX] folder
		self.core2_name		= "Aircrafts/Engines/UH-60L/FrontEngine"
		self.jet_name		= "Aircrafts/Engines/UH-60L/EngineJet"
		self.jet2_name		= "Aircrafts/Engines/UH-60L/EngineJet"
		self.fan_name		= "Aircrafts/Engines/UH-60L/EngineJet"
		self.turb_name		= "Aircrafts/Engines/UH-60L/EngineJet"
		self.around_name	= "Aircrafts/Engines/UH-60L/AroundEngine"
		self.around2_name	= "Aircrafts/Engines/UH-60L/AroundEngine"
		self.rotor_name		= "Aircrafts/Engines/UH-60L/RotorExterior"
		self.apu_name		= "Aircrafts/Engines/UH-60L/APU"
end
...
function engine:initCptNames()
	self.engine_l_name  = "Aircrafts/Engines/UH-60L/InEngineL" -- path to sdef files in the [Mods\aircraft\PlaneXXX\Sounds\Effects\Aircrafts\Engines\PlaneXXX] folder
	self.engine_r_name  = "Aircrafts/Engines/UH-60L/InEngineR"
	self.heAmb_l_name   = "Aircrafts/Engines/UH-60L/InEngineL"
	self.heAmb_r_name   = "Aircrafts/Engines/UH-60L/InEngineR"
	self.rotorCpt		= "Aircrafts/Engines/UH-60L/Rotor"
	self.apuCpt			= "Aircrafts/Engines/UH-60L/APUIn"
end
