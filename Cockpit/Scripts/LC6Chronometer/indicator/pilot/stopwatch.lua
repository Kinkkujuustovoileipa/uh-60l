...
base.controllers     = {{"parameter_in_range",0,0.9,1.1},{"parameter_in_range",1,3.9,4.1}}
Add(base)
...
ltHrs.formats         = {"%2.0f"}
ltHrs.element_params  = {"PILOT_LC6_SW_HRS"}
...
ltMins.element_params  = {"PILOT_LC6_SW_MINS"}
...
ltSecs.element_params  = {"PILOT_LC6_SW_SECS"}
