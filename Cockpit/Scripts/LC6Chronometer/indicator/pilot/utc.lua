...
dofile(LockOn_Options.script_path..'LC6Chronometer/indicator/pilot/defines.lua')
...
base.isvisible		 = true
base.element_params  = {"CB_PILOT_ALTM", "PILOT_LC6_MODE"}
base.controllers     = {{"parameter_in_range",0,0.9,1.1},{"parameter_in_range",1,1.9,2.1}}
Add(base)
...
ltHrs.formats         = {"%2.0f"}
ltHrs.element_params  = {"PILOT_LC6_UTC_HRS"}
...
ltMins.element_params  = {"PILOT_LC6_UTC_MINS"}
...
ltSecs.element_params  = {"PILOT_LC6_UTC_SECS"}
...
mode.init_pos	     = {-0.01, -0.005, 0} -- L/R, D/U, F/B
mode.stringdefs      = stringdefsSmall
mode.formats         = {"%s"}
mode.value           = "UTC"
mode.controllers     = {{"text_using_parameter",0,0}}
mode.h_clip_relation = h_clip_relations.compare
mode.level			 = 6
