...
ltHrs.formats         = {"%2.0f"}
ltHrs.element_params  = {"PILOT_LC6_LT_HRS"}
...
ltMins.element_params  = {"PILOT_LC6_LT_MINS"}
...
ltSecs.element_params  = {"PILOT_LC6_LT_SECS"}
...
mode.init_pos	     = {-0.015, -0.005, 0} -- L/R, D/U, F/B
