...
base.controllers     = {{"parameter_in_range",0,0.9,1.1},{"parameter_in_range",1,4.9,5.1}}
Add(base)
...
ltHrs.formats         = {"%2.0f"}
ltHrs.element_params  = {"PILOT_LC6_DC_HRS"}
...
ltMins.element_params  = {"PILOT_LC6_DC_MINS"}
...
ltSecs.element_params  = {"PILOT_LC6_DC_SECS"}
...
mode.init_pos	     = {0.018, -0.005, 0} -- L/R, D/U, F/B
