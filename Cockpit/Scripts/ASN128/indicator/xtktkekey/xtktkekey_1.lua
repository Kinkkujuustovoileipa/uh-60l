...
base.controllers     = {{"parameter_in_range",0,0.9,1.1}, {"parameter_in_range",1,XTKTKEKEY_1}}
Add(base)

createTextLine(line1Pos, {"ASN128_GENERIC_TOP_LINE"}, {{"text_using_parameter",0, 0}}, base)
createTextLine(line2Pos, {"ASN128_COURSEDISPLAY"}, {{"text_using_parameter",0, 0}}, base)
createTextLine(line3Pos, {"ASN128_XTK"}, {{"text_using_parameter",0, 0}}, base)
createTextLine(line4Pos, {"ASN128_TKE"}, {{"text_using_parameter",0, 0}}, base)
