...
base.controllers     = {{"parameter_in_range",0,0.9,1.1}, {"parameter_in_range",1,DISTBRGTIME_3}}
Add(base)

createTextLine(line1Pos, {"ASN128_GENERIC_TOP_LINE"}, {{"text_using_parameter",0, 0}}, base)
createTextLine(line2Pos, {"ASN128_CURRWP"}, {{"text_using_parameter",0, 0}}, base)
createHardcodedTextLine(line3Pos, "5h 38.15min", base)
createHardcodedTextLine(line4Pos, "IDLE", base)
createHardcodedTextLine(line6Pos, "RAIM", base, "RightCenter")
createTextLine(line7Pos, {"ASN128_PHASESHORT"}, {{"text_using_parameter",0, 0}}, base, "RightCenter")
