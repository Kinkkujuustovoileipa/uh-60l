...
base.controllers     = {{"parameter_in_range",0,0.9,1.1}, {"parameter_in_range",1,DISTBRGTIME_2}}
Add(base)

createTextLine(line1Pos, {"ASN128_GENERIC_TOP_LINE"}, {{"text_using_parameter",0, 0}}, base)
createTextLine(line2Pos, {"ASN128_PHASE"}, {{"text_using_parameter",0, 0}}, base)
createHardcodedTextLine(line3Pos, "LOI: NO", base)
createHardcodedTextLine(line4Pos, "HPOS: P", base)
