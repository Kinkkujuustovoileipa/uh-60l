...
base.controllers     = {{"parameter_in_range",0,0.9,1.1}, {"parameter_in_range",1,WINDUTC_DAFIF}}
Add(base)

createHardcodedTextLine(line1Pos, "START DAFIF", base)
createHardcodedTextLine(line2Pos, "DOWNLOAD? NO", base)
