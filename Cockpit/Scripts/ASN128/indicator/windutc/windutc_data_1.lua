...
base.controllers     = {{"parameter_in_range",0,0.9,1.1}, {"parameter_in_range",1,WINDUTC_DATA_1}}
Add(base)


createTextLine(line1Pos, {"ASN128_GENERIC_TOP_LINE"}, {{"text_using_parameter",0, 0}}, base)
createHardcodedTextLine(line2Pos, "WIND", base)
createTextLine(line3Pos, {"ASN128_WIND_SPEED"}, {{"text_using_parameter",0, 0}}, base)
createTextLine(line4Pos, {"ASN128_WIND_DIR"}, {{"text_using_parameter",0, 0}}, base)
