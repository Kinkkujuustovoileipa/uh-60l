...
base.controllers     = {{"parameter_in_range",0,0.9,1.1}, {"parameter_in_range",1,WINDUTC_DATA_3}}
Add(base)

createHardcodedTextLine(line1Pos, "1) NETWORKING", base)
createHardcodedTextLine(line2Pos, "2) DATA LOAD", base)
createHardcodedTextLine(line3Pos, "3) DAFIF DOWNLOAD", base)
createHardcodedTextLine(line4Pos, "4) CONFIG", base)
