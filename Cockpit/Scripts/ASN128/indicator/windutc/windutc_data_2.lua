...
base.controllers     = {{"parameter_in_range",0,0.9,1.1}, {"parameter_in_range",1,WINDUTC_DATA_2}}
Add(base)


createTextLine(line1Pos, {"ASN128_GENERIC_TOP_LINE"}, {{"text_using_parameter",0, 0}}, base)
createTextLine(line2Pos, {"ASN128_DATE"}, {{"text_using_parameter",0, 0}}, base)
createTextLine(line3Pos, {"ASN128_TIME"}, {{"text_using_parameter",0, 0}}, base)
createHardcodedTextLine(line4Pos, "INIT GPS: N", base) --not implemented feature
