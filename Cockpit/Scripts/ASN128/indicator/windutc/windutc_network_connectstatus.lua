...
base.controllers     = {{"parameter_in_range",0,0.9,1.1}, {"parameter_in_range",1,WINDUTC_NETWORKCONNECTSTATUS}}
Add(base)

createHardcodedTextLine(line1Pos, "CONNECT STATE:", base)
createTextLine(line2Pos, {"ASN128_CLIENT_STATUS"}, {{"text_using_parameter",0, 0}}, base)
