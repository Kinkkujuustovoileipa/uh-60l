...
base.controllers     = {{"parameter_in_range",0,0.9,1.1}, {"parameter_in_range",1,WINDUTC_DOWNLOAD}}
Add(base)

createHardcodedTextLine(line1Pos, "WPT DOWNLOAD", base)
createHardcodedTextLine(line2Pos, "START: NO", base)
createHardcodedTextLine(line3Pos, "NOT IN PROGRESS", base)
