...
base.controllers     = {{"parameter_in_range",0,0.9,1.1}, {"parameter_in_range",1,WINDUTC_CONFIG}}
Add(base)

createHardcodedTextLine(line1Pos, "MODE: DELTA", base)
createHardcodedTextLine(line2Pos, "TK: MAGNETIC", base)
createHardcodedTextLine(line3Pos, "DTK: TRUE", base)
createHardcodedTextLine(line4Pos, "WAGE: N", base)
