...
base.controllers     = {{"parameter_in_range",0,0.9,1.1}, {"parameter_in_range",1,WPTGT_2}}
Add(base)
...
createTextLine(line3Pos, {"ASN128_WP_GPSALT", "ASN128_WP_GPSALT_VIS"}, {{"text_using_parameter",0, 0}, {"opacity_using_parameter", 1}}, base)
createHardcodedTextLine(line4Pos, "AUTO/MAN: A", base)
createTextLine(line6Pos, {"ASN128_WP_MAGVAR"}, {{"text_using_parameter",0, 0}}, base, "RightCenter")
