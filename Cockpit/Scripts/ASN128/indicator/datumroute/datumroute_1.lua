...
base.controllers     = {{"parameter_in_range",0,0.9,1.1}, {"parameter_in_range",1,DATUMROUTE_1}}
Add(base)

createHardcodedTextLine(line1Pos, "1) FLIGHT PLAN", base)
createHardcodedTextLine(line2Pos, "2) WP LOOKUP", base)
createHardcodedTextLine(line3Pos, "3) IAP LOOKUP", base)
createHardcodedTextLine(line4Pos, "4) R/T CONSEC", base)
