...
base.controllers     = {{"parameter_in_range",0,0.9,1.1}, {"parameter_in_range",1,DATUMROUTE_2}}
Add(base)

createTextLine(line1Pos, {"ASN128_GENERIC_TOP_LINE"}, {{"text_using_parameter",0, 0}}, base)

createHardcodedTextLine(line3Pos, "WGS-84", base)
createHardcodedTextLine(line4Pos, "DATUM: ??", base)
