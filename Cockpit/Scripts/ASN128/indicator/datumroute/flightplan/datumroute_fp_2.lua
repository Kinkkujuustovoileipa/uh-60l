...
base.controllers     = {{"parameter_in_range",0,0.9,1.1}, {"parameter_in_range",1,DATUMROUTE_FP_2}}
Add(base)

createTextLine(line1Pos, {"ASN128_FLIGHTPLAN_CURR_FLIGHTPLAN"}, {{"text_using_parameter",0, 0}}, base)
createHardcodedTextLine(line2Pos, "1) ACTIVATE", base)
createHardcodedTextLine(line3Pos, "2) REVIEW", base)
createHardcodedTextLine(line4Pos, "3) ETA/ETE", base)
