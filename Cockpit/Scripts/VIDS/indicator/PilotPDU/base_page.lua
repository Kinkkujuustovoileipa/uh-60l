...
local center = calculateIndicatorCenterDash({0.35,-0.623,2.602}) -- {L/R,U/D,forward/back}
...
base.element_params  = {"CB_NO2_AC_INST", "CB_NO2_DC_INST"}
...
eng1TrqText.element_params  = {"PDU_PLT_E1_TRQ"}
...
eng2TrqText.element_params  = {"PDU_PLT_E2_TRQ"}
...
for x = 0, 60, 10 do
	...
	E1RPM_1.element_params     = {"PDU_PLT_E1NP_LOW"}
...
for x = 70, 85, 5 do
	...
	E1RPM_2.element_params     = {"PDU_PLT_E1NP_LOW"}
	local color	               = redColor
...
for x = 90, 94, 1 do
	...
	E1RPM_3.element_params     = {"PDU_PLT_E1NP_LOW"}
...
for x = 95, 100, 1 do
	...
	E1RPM_4.element_params     = {"PDU_PLT_E1NP_HI"}
...
for x = 101, 104, 1 do
	...
	E1RPM_5.element_params     = {"PDU_PLT_E1NP_HI"}
	local color	               = yellowColor
...
for x = 105, 109, 1 do
	...
	E1RPM_6.element_params     = {"PDU_PLT_E1NP_HI"}
	local color	               = redColor
...
for x = 110, 128, 2 do
	...
	E1RPM_7.element_params     = {"PDU_PLT_E1NP_HI"}
	local color	               = redColor
...
for x = 0, 60, 10 do
	...
	RRPM_1.element_params     = {"PDU_PLT_RRPM_LOW"}
	local color	               = redColor
...
for x = 70, 85, 5 do
	...
	RRPM_2.element_params     = {"PDU_PLT_RRPM_LOW"}
	local color	               = redColor
...
for x = 90, 94, 1 do
	...
	RRPM_3.element_params     = {"PDU_PLT_RRPM_LOW"}
	local color	               = yellowColor
	if ( x < 91)
	then
		color = redColor
...
for x = 95, 100, 1 do
	...
	RRPM_4.element_params     = {"PDU_PLT_RRPM_HI"}
	local color	               = greenColor
...
for x = 101, 104, 1 do
	...
	RRPM_5.element_params     = {"PDU_PLT_RRPM_HI"}
	local color	               = yellowColor
...
for x = 105, 109, 1 do
	...
	RRPM_6.element_params     = {"PDU_PLT_RRPM_HI"}
	local color	               = redColor
...
for x = 110, 128, 2 do
	...
	RRPM_7.element_params     = {"PDU_PLT_RRPM_HI"}
	local color	               = redColor
...
for x = 0, 60, 10 do
	...
	E2RPM_1.element_params     = {"PDU_PLT_E2NP_LOW"}
	local color	               = redColor
...
for x = 70, 85, 5 do
	...
	E2RPM_2.element_params     = {"PDU_PLT_E2NP_LOW"}
	local color	               = redColor
...
for x = 90, 94, 1 do
	...
	E2RPM_3.element_params     = {"PDU_PLT_E2NP_LOW"}
	local color	               = yellowColor
	if ( x < 91)
	then
		color = redColor
...
for x = 95, 100, 1 do
	...
	E2RPM_4.element_params     = {"PDU_PLT_E2NP_HI"}
	local color	               = greenColor
...
for x = 101, 104, 1 do
	...
	E2RPM_5.element_params     = {"PDU_PLT_E2NP_HI"}
	local color	               = yellowColor
...
for x = 105, 109, 1 do
	...
	E2RPM_6.element_params     = {"PDU_PLT_E2NP_HI"}
	local color	               = redColor
...
for x = 110, 128, 2 do
	...
	E2RPM_7.element_params     = {"PDU_PLT_E2NP_HI"}
	local color	               = redColor
...
for x = 0, 145, 5 do
	...
	E1TRQ.element_params   = {"PDU_PLT_E1TRQ"}
	local color	           = greenColor
	if (x > 100) then
		color = yellowColor
	end
...
for x = 0, 145, 5 do
	...
	E1TRQ.init_pos	 	   = { _posX, _posY + _i*(Ysize + _ySpacing), _posZ}
	E1TRQ.controllers 	   = {{"parameter_in_range", 0, x, 160}}
	E1TRQ.element_params   = {"PDU_PLT_E2TRQ"}
	local color	           = greenColor
	if (x > 100) then
		color = yellowColor
	end
