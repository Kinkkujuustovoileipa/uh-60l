...
mainWheelRadius	= 0.5
tailWheelRadius	= 0.35
animArgTailWheelYaw = 2
animArgTailWheelAmort = 1
animArgTailWheelRot = 101
animArgLeftWheelAmort = 6
animArgLeftWheelRot = 103
animArgRightWheelAmort = 4
animArgRightWheelRot = 102
...
main_amortizer_reduce_length 				= 35--28.0  --yes you read that right, 28 metres.
...
main_amortizer_spring_force_factor 			= 7e8--7e7--1e8--100.0e+7--7.0e+7
...
nose_amortizer_max_length 					= 1--0.67--0.67 --0.32
nose_amortizer_basic_length 				= 0.67--0.67--0.3
nose_amortizer_reduce_length 				= 35

nose_amortizer_spring_force_factor 			= main_amortizer_spring_force_factor--1e6--3.0e+06
nose_amortizer_spring_force_factor_rate 	= main_amortizer_spring_force_factor_rate--2.0

--nose_amortizer_static_force = 5e+4
nose_amortizer_static_force 				= 5256.0 * 9.81 * 0.2
nose_damper_force 							= main_damper_force--1e3--2.0e+4
